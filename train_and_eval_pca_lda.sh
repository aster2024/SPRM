...
for model in "llama3-8b" "mistral-7b" ; do
    ...
    echo "Training pca-lda model $model_name."
    CUDA_VISIBLE_DEVICES=3 python train/train_pca_lda.py --model_name $model_name --max_samples $max_samples
    CUDA_VISIBLE_DEVICES=3 python eval/bon_eval_pca_lda.py --model_name $model_name --dataset_file $dataset_file --eval_mode min
    CUDA_VISIBLE_DEVICES=3 python eval/bon_eval_pca_lda.py --model_name $model_name --dataset_file $dataset_file --eval_mode product
    CUDA_VISIBLE_DEVICES=3 python eval/bon_eval_pca_lda.py --model_name $model_name --dataset_file $dataset_file --eval_mode orm
done
