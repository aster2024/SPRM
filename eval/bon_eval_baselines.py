...
from eval.prm_eval_utils import *
...
if __name__=='__main__':
    ...
    parser.add_argument("--type", type=str, default='implicit_prm',choices=['implicit_prm','baseline-value-head','baseline-ntp','implicit_prm-orm','implicit_prm_lens'])
