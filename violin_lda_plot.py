...
def main():
    ...
    print(correct_points, incorrect_points)


    plt.figure(figsize=(10, 6))

    df = pd.DataFrame({'LDA Component 1': features_1d, 'Correctness': labels_np})
    print(features_1d, labels_np)

    sns.violinplot(x='Correctness', y='LDA Component 1', data=df, palette={"0": 'orange', "1": 'darkblue'})

    plt.xlabel("Correctness (0: Incorrect, 1: Correct)")
    plt.ylabel("LDA Component 1")
    plt.title("LDA Projection and Distribution (Violin Plot)")
    plt.tight_layout()
