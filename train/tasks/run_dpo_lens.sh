...
lensdata=./data/ultrainteract_math_rollout_lens.json
datapath=./processed_data/$train_dir
modelpath=HuggingFaceTB/SmolLM-135M-Instruct
policymodelpath=meta-llama/Llama-3.1-8B-Instruct
...
openrlhf.cli.train_dpo \
   ...
   --use_lens_json \
   --lens_json_path $lensdata \
   --policy_model_name $policymodelpath
